...
import SeekerContext from '../context/seeker/seekerContext'
// import checkToken from '@/components/checkToken';
import { PencilIcon } from '@heroicons/react/24/outline';
import ProfileImage from '@/components/ProfileImage';
const page = () => {
  const { getSeeker, seeker } = useContext(SeekerContext);
        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          <div className="col-span-4 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                {/* <img src="https://randomuser.me/api/portraits/men/94.jpg" className=""> */}
                ...
                <p className="text-gray-600 text-center">{user.profession || 'your profession here'}</p>
              ...
              <div className="flex flex-col ">
                ...
                <ul>
                  <li className="mb-2 text-gray-600 whitespace-normal">daniyallodhi25@gmail.com</li>
                </ul>
              </div>
              <div className="flex flex-col ">
                <span className="uppercase font-bold tracking-wider mb-2">Address</span>
                <ul>
                  <li className="mb-2 text-gray-600">ShahFaisal Colony Number 3</li>
                  <li className="mb-2 text-gray-600">Karachi, Pakistan</li>
                </ul>
              </div>
              {/* Edit - save button */}

              <div className='mt-8 flex justify-end space-x-4'>
                <button className='bg-indigo-500 flex justify-center items-center space-x-2 hover:bg-indigo-600 rounded-md text-white py-1 px-4 mr-2'>Edit
                  <PencilIcon color='white' width={15} height={15} className='ml-2 inline align-middle' />
                </button>
                <button className='bg-indigo-600 hidden hover:bg-indigo-800 rounded-md text-white py-1 px-4 fontM '>Save</button>
              </div>
            </div>
          </div>
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-gray-700">{user.description}
              </p>
